export const bookingLocators = {
  ...
  // Aswin - added locators for price summary and calendar

  priceSummary: (page) => page.locator('.price-summary'),

  roomRate: (page) =>
    page.locator('.price-summary').getByText(/night/i),

  cleaningFee: (page) =>
    page.locator('.price-summary').getByText('Cleaning fee').locator('..'),

  serviceFee: (page) =>
    page.locator('.price-summary').getByText('Service fee').locator('..'),
